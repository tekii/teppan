...
- `TEPPAN_BUILD/DOC/.../img/logo.png : __SRC__/img/logo.png` (prerequisite-only;
  the actual copy recipe comes from the `%.png:` pattern rule in
  `Makefile`)
- `clean-asset :: ; -rm -f TEPPAN_BUILD/DOC/.../img/logo.png`
- `TEPPAN_BUILD/DOC/.../es/news.html : TEPPAN_BUILD/DOC/.../img/logo.png`
