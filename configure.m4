...
m4_define([__MAGIC_COMMENT_TO_AVOID_MESS_WITH_CSS_HIGHLIGHT_WHILE_INCLUDE_AMP_CUSTOM_CSS__],[dnl
 BEGIN AMP-CUSTOM.CSS */m4_newline([])__INCL([amp-custom.css])m4_newline([/* END AMP-CUSTOM.CSS ])])
m4_define([__MAGIC_COMMENT_TO_AVOID_MESS_WITH_CSS_HIGHLIGHT_WHILE_UNDIVERT_AMP_CUSTOM_STYLES__],[dnl
 BEGIN AMP CUSTOM STYLES */m4_newline([])m4_undivert([AMP_CUSTOM_STYLES])m4_newline([/* END AMP CUSTOM STYLES ])])
dnl
